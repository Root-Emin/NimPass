import type { Pass, PublicPass, PublicProvider, PublicService } from '@/types/domain'

/**
 * Presentation fixtures for the public catalogue. See ../README.md.
 *
 * Shaped as `PublicPass`, exactly as `GET /public/passes` returns it, so a
...
const PROVIDERS: PublicProvider[] = [
  {
    ...
    name: 'Alex Fitness',
    slug: 'alex-fitness',
    headline: 'Strength training that fits around a working week',
    bio: 'Ten years coaching people who train twice a week and want that to count.',
    avatarUrl: '',
    avatarVariant: 0,
    location: 'Istanbul',
    wallet: 'NQ07 0000 0000 0000 0000 0000 0000 0000 0001',
  },
  {
    id: '10000000-0000-4000-8000-000000000002',
    name: 'Mira Bendz',
    slug: 'mira-bendz',
    headline: 'German for people who need it at work',
    bio: 'Conversation-first lessons from the very first hour.',
    avatarUrl: '',
    avatarVariant: 0,
    location: 'Berlin',
    wallet: 'NQ07 0000 0000 0000 0000 0000 0000 0000 0002',
  },
  {
    id: '10000000-0000-4000-8000-000000000003',
    name: 'Kaan Studio',
    slug: 'kaan-studio',
    headline: 'Guitar, from first chord to first set',
    bio: 'Beginners and returning players, acoustic or electric.',
    avatarUrl: '',
    avatarVariant: 0,
    location: 'Izmir',
    wallet: 'NQ07 0000 0000 0000 0000 0000 0000 0000 0003',
  },
]
...
function pkg(index: number, overrides: Partial<Pass>): Pass {
  return {
...
export const FIXTURE_OFFERS: PublicPass[] = [
  {
    pass: pkg(1, {
